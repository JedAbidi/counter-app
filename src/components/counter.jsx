    ...
    */
    render() { 
        ...
        return(
            ...
            <button 
                onClick={() => {this.props.onIncrement(this.props.counter)}} className="btn btn-secondary btn-sm">PLUS</button>
            <button 
    ...
    formatCount(){
        const {value} = this.props.counter //destructering to avoid writing this.state.count everytime
